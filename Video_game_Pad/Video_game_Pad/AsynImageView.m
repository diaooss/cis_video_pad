...
-(void)setImageURL:(NSString *)imageURL
{
    ...
    {
        if (_placeholderImage==nil) {
//            NSLog(@"%@",_placeholderImage);
//            _placeholderImage=[UIImage imageNamed:@"palce.png"];
        }
    ...
    if(self.imageURL)
    {
        ...
        NSMutableArray *lineArray =(NSMutableArray*)[self.imageURL componentsSeparatedByString:@"/"];
        
        
        self.fileName = [NSString stringWithFormat:@"%@/%@", tmpPath,[lineArray lastObject]];
